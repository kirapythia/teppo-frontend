...
describe('getSortedComments', () => {
  ...
  it('should sort secondarily on createAt property', () => {
    const comments = {
      1: { ptextId: 1, planId: 1, approved: true, createdAt: '2017-10-12T13:35:14.591Z' },
      2: { ptextId: 2, planId: 1, approved: true, createdAt: '2017-08-10T13:35:14.591Z' },
      3: { ptextId: 3, planId: 1, approved: true, createdAt: '2017-09-11T12:35:14.591Z' },
    };
